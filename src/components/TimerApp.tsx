...
export default function TimerApp() {
    ...
    const toggleMode = () => {
        setTimeLeft(mode === 'work' ? { minutes: breakDuration, seconds: 0 } : { minutes: workDuration, seconds: 0 });
    ...
    useEffect(() => {
        const testGemini = async () => {
            const suggestion = await generateRefreshSuggestions();
